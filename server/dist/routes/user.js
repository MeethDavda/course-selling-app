...
router.post("/signup", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user) {
        ...
        yield newUser.save();
        const token = jsonwebtoken_1.default.sign({ id: newUser._id, role: "user" }, auth_1.SECRET, {
            expiresIn: "1h",
        });
...
router.post("/login", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user) {
        const token = jsonwebtoken_1.default.sign({ id: user._id, role: "user" }, auth_1.SECRET, {
            expiresIn: "1h",
        });
...
router.get("/purchasedCourses", auth_1.authenticateJwt, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield db_1.User.findOne({ _id: req.headers["userId"] }).populate("purchasedCourses");
    if (user) {
